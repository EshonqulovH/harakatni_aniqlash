...
class HandTracking(VideoTransformerBase):
    def __init__(self):
...
st.title("Qo'l Harakati Aniqlash (Mediapipe)")
webrtc_streamer(key="hand-tracking", video_transformer_factory=HandTracking)
